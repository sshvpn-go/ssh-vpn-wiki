...
ssh-vpn 开源社区版始终支持 100% 自托管部署。为了提供更持续的开发动力和高级功能支持，我们推出了以下订阅方案。
...
<div id="ssh-vpn-pricing" class="pricing-container">
  ...
  <div class="pricing-card">
    ...
    <div class="plan-desc">与主流 VPN 月费价格持平，为短期或试用用户提供灵活选择。</div>
  ...
  <div class="pricing-card featured">
    ...
    <div class="plan-desc">提供最具性价比的订阅体验，适合长期使用的进阶用户。</div>
    <ul class="plan-features">
  ...
  <div class="pricing-card">
    ...
    <div class="plan-desc">满足希望“一劳永逸”的重度用户，不仅是订阅，更是对项目的赞助。</div>
    <ul class="plan-features">
...
## 开源自托管 (Self-Hosted)
如果您拥有自己的基础设施并乐于折腾，您依然可以免费使用 ssh-vpn：
- **核心功能**: 100% 免费开源
